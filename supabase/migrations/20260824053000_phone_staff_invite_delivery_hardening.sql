...
begin
  ...
  -- A receptionist should never have multiple live links for the same clinic.
  -- Reinviting the same phone revokes older unused links before creating the new one.
