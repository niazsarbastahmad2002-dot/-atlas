...
comment on column public.doctors.specialty is 'Patient-facing doctor specialty or subspecialty.';
comment on column public.doctors.receptionist_phone is 'Patient-facing clinic/reception contact number for this doctor, preferably normalized to E.164.';
...
begin
  ...
  select
    ...
    positioned.doctor_specialty,
    positioned.receptionist_phone,
