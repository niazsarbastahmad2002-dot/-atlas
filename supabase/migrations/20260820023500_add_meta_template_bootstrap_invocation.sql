...
revoke all on function private.invoke_atlas_meta_template_bootstrap() from public, anon, authenticated;

comment on function private.invoke_atlas_meta_template_bootstrap() is
  'Creates a short-lived one-time token and invokes the protected Atlas Meta appointment reminder template bootstrap for the production WABA.';
