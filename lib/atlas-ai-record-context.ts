...
const detailWords = [
  "detail", "details", "patient", "patients", "who", "name", "names", "phone", "number", "contact", "appointment", "appointments",
  "نەخۆش", "ناو", "ناوی", "ژمارە", "مۆبایل", "موبایل", "وردەکاری", "زانیاری", "مەوعید", "کێ", "کەی",
  "ناڤ", "ژمارا", "موبایلێ", "پسیار", "مريض", "المرضى", "اسم", "أسماء", "رقم", "هاتف", "تلفون", "تفاصيل", "موعد", "مواعيد", "منو", "مين",
];

const phoneWords = [
  "phone", "mobile", "number", "contact",
  "ژمارە", "مۆبایل", "موبایل", "ژمارا", "موبایلێ",
  "رقم", "هاتف", "تلفون", "موبايل",
];
