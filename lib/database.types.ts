...
export type Database = {
  ...
  public: {
    ...
    Functions: {
      ...
      get_patient_appointment: { Args: { p_token_hash: string }; Returns: { appointment_at: string; appointment_status: string; appointments_ahead: number; clinic_name: string; doctor_name: string; queue_position: number; reminder_language: string; token_expires_at: string }[] }
