...
const copy = {
  ...
  ku: {
    ...
    phoneHelp: "بۆ بیرخستنەوە بە شێوەی +964 پاشەکەوت دەکرێت.",
    doctor: "پزیشک",
    ...
    saveAppointment: "وادە پاشەکەوت بکە",
    ...
    saveInterval: "ماوە پاشەکەوت بکە",
    addDoctor: "پزیشک زیاد بکە",
    doctorName: "ناوی پزیشک",
    saveName: "ناو پاشەکەوت بکە",
    moveUp: "بەرەو سەرەوە",
