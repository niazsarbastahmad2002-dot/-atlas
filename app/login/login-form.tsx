...
const authCopy = {
  ...
  bd: {
    emailHint: "ئیمەیلا کاری یا کو پێشتر بۆ ڤێ کلینیکێ هاتییە ئامادەکرن بکاربینە.",
    send: "ئیمەیلا Atlas بهنێرە",
    sentTitle: "ئیمەیلا Atlas هاتە هنارتن.",
    sentHelp: "سندوقا ئیمەیلێ ڤەکە، نووترین ئیمەیلا چوونەژوورێ هەلبژێرە و Open Atlas بکە.",
    openInbox: "ئیمەیلێ ڤەکە",
    returnHelp: "دەمێ لینک ڤەدبیت، Atlas ڕاستەوخۆ خشتەیا وادەیان ڤەدکەت. چ ڕێکخستنێن دی پێدڤی نینن.",
    resend: "ئیمەیلا نوو بهنێرە",
    another: "ئیمەیلا دی بکاربینە",
    quick: "چوونەژوورا خێرا",
    quickOpening: "چوونەژوورا خێرا ڤەدبیت…",
    quickHelp: "ئارەزوومەندانەیە. تەنێ ئەگەر پێشتر چوونەژوورا خێرا بۆ ڤی هەژماری پاراستییە بکاربینە.",
    quickCancelled: "چوونەژوورا خێرا هاتە هەلوەشاندن. چوونەژوور ب ئیمەیلا کاری هێشتا بەردەستە.",
    quickUnavailable: "چوونەژوورا خێرا ل ڤێرێ ڕێک نەخراوە. ئیمەیلا کاری بکاربینە.",
    invalidEmail: "ئیمەیلا کاری یا کلینیکێ بنڤیسە.",
    rateLimited: "ئیمەیلا نوو نەهاتە هنارتن. چوونەژوور ب ئیمەیلێ نوکە سنووردارە. ئەگەر پێشتر داخواز کری، تەنێ نووترین ئیمەیلا Atlas بکاربینە؛ نەخۆ پاشتر دووبارە هەول بدە.",
    notReady: "Atlas نەشیا بۆ ڤی هەژماری ئیمەیلا چوونەژوورێ بهنێریت. ناڤونیشانێ بپشکنە یان ژ کلینیکێ بخوازە هەژمارێ ئامادە بکەت.",
    network: "Atlas نەشیا چوونەژوورێ دەست پێ بکەت. پەیوەندیا ئینتەرنێتێ بپشکنە و دووبارە هەول بدە.",
  },
  ar: {
