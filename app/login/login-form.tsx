...
const authCopy = {
  en: {
    phoneHint: "Enter your mobile number. Iraq numbers can start with 07; international numbers should include +country code.",
    ...
    invalidPhone: "Enter a valid mobile number with a country code, for example +9647501234567.",
    ...
    notReady: PHONE_SIGNUP_ENABLED
      ...
      : "This number is not linked to an Atlas account yet. Existing accounts must add and verify a phone number before phone-only signup is opened.",
    ...
    quickHelp: "Optional on a device where you previously saved a passkey.",
  ...
  ku: {
    phoneHint: "ژمارەی مۆبایلەکەت بنووسە. ژمارەی عێراق دەتوانێت بە 07 دەست پێ بکات؛ بۆ دەرەوەی عێراق +کۆدی وڵات بنووسە.",
    ...
    invalidPhone: "ژمارەیەکی دروستی مۆبایل بنووسە، وەک +9647501234567.",
  ...
  bd: {
    phoneHint: "ژمارا موبایلا خۆ بنڤیسە. ژمارێن عێراقێ دشێن ب 07 دەست پێ بکەن؛ بۆ دەرڤەی عێراقێ +کۆدێ وەلاتی بنڤیسە.",
    ...
    invalidPhone: "ژمارەکا دروست یا موبایلێ بنڤیسە، وەک +9647501234567.",
  ...
  ar: {
    phoneHint: "اكتب رقم موبايلك. الرقم العراقي ممكن يبدأ بـ 07، وللأرقام الدولية استخدم + ورمز الدولة.",
    ...
    invalidPhone: "أدخل رقم موبايل صحيح مع رمز الدولة، مثلاً +9647501234567.",
...
function rememberCooldown(seconds: number) {
  try {
    ...
    // Authentication must keep working when localStorage is unavailable.
  }
}
...
export function LoginForm({ locale }: { locale: UiLocale }) {
  ...
  async function sendCode(event?: FormEvent) {
    ...
    const phone = normalizeAuthPhone(step === "code" ? verifiedPhone : phoneInput);
    if (!phone) {
