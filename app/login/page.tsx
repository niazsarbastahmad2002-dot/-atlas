...
const pageCopy: Record<UiLocale, LoginPageCopy> = {
  ...
  ku: {
    ...
    subtitle: "کاتەکان ئامادەن. کاری ڕیسێپشن ڕوون و خێرایە.",
    ...
    stagePulse: "شوێنی کاری پارێزراوی ڕیسێپشن",
    language: "زمانەکەت هەڵبژێرە",
  },
  bd: {
    eyebrow: "ریسپشن",
    title: "Atlas ڤەکە. ڕۆژا کلینیکێ دەست پێ بکە.",
    subtitle: "وادە ئامادەن. کارێ ریسپشنێ ڕوون و خێرایە.",
    ...
    stagePulse: "شوێنێ کاری پاراستی یێ ریسپشنێ",
