...
const pageCopy: Record<UiLocale, LoginPageCopy> = {
  ...
  ku: { eyebrow: "پێشخانە", title: "Atlas بکەرەوە. ڕۆژی کلینیک دەستپێبکە.", subtitle: "جارێک بە ئیمەیڵی کاری کلینیک بچۆ ژوورەوە. Atlas ئامێری متمانەپێکراو بۆ پێشخانە ئامادە دەهێڵێتەوە.", invalid: "ئەم بەستەرە بەسەرچووە یان پێشتر بەکارهاتووە. ئیمەیڵێکی نوێی Atlas داوا بکە.", signedOut: "بە سەلامەتی چوویتە دەرەوە.", storyKicker: "بۆ پێشخانە دروست کراوە", storyTitle: "ڕۆژی کلینیک، بەبێ ئاڵۆزی.", storySubtitle: "یەک شوێنی خێرا بۆ وادەکان، پشتڕاستکردنەوەی نەخۆش و کاری ڕۆژانەی پێشخانە.", book: "وادە بە خێرایی", bookHelp: "نەخۆش، پزیشک، ڕێکەوت و کات — بەبێ گەڕان بە پەڕەکاندا.", remind: "بیرخستنەوەی خۆکار", remindHelp: "Atlas بیرخستنەوەی WhatsApp لە کاتی هەڵبژێردراوی کلینیک ئامادە دەکات.", confirm: "بزانە کێ دێت", confirmHelp: "نەخۆش دەتوانێت وادەکەی پشتڕاست بکات یان هەڵیوەشێنێتەوە.", confirmed: "نەخۆش پشتڕاستی کردەوە", next: "وادەی داهاتوو", language: "زمانەکەت هەڵبژێرە" },
...
export default async function LoginPage({ searchParams }: LoginPageProps) {
  ...
  return <main className="login-page">
    ...
    <aside className="login-visual">
      <div className="login-visual-lines" aria-hidden="true" />
      <div className="login-story">
        <div className="login-story-brand"><span className="login-story-logo" aria-hidden="true" /><span>{copy.storyKicker}</span></div>
        <h2>{copy.storyTitle}</h2>
        <p>{copy.storySubtitle}</p>
        <div className="login-story-steps">
          <article><span className="login-story-number">01</span><div><strong>{copy.book}</strong><small>{copy.bookHelp}</small></div></article>
          <article><span className="login-story-number">02</span><div><strong>{copy.remind}</strong><small>{copy.remindHelp}</small></div></article>
          <article><span className="login-story-number">03</span><div><strong>{copy.confirm}</strong><small>{copy.confirmHelp}</small></div></article>
        </div>
        <div className="login-mini-schedule" aria-label={t.schedule}><div className="login-mini-heading"><span>ATLAS</span><strong>{t.schedule}</strong></div><div className="login-visual-card"><span className="login-visual-dot" /><div><strong>08:30</strong><span>{copy.confirmed}</span></div></div><div className="login-visual-card is-secondary"><span className="login-visual-dot" /><div><strong>09:00</strong><span>{copy.next}</span></div></div></div>
      </div>
    </aside>
  </main>;
}
