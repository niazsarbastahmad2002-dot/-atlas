...
const copy = {
  ...
  ku: {
    ...
    phone: "ژمارەی ڕیسێپشن بۆ ئەم پزیشکە",
    phonePlaceholder: "0750 123 4567",
    receptionistNote: "ستافی ڕیسێپشن دەتوانێت ژمارەی پەیوەندی نەخۆش بگۆڕێت. بەڕێوەبەر پسپۆڕی پزیشک دیاری دەکات.",
    save: "پاشەکەوتکردن",
  ...
  bd: {
    eyebrow: "پەرەیا نەخۆشی",
    title: "زانیاریێن دکتۆری و پەیوەندیێ",
    help: "ب ڕوونی ل پەرەیا تایبەت یا وادەیا نەخۆشی دهێتە نیشاندان.",
    doctor: "دکتۆر",
    specialty: "تایبەتمەندی / تایبەتمەندیا ورد",
    specialtyPlaceholder: "بۆ نموونە: نەشتەرگەریا ئێسک و جومگە",
    phone: "ژمارا ڕیسێپشنێ بۆ ڤی دکتۆری",
    phonePlaceholder: "0750 123 4567",
    receptionistNote: "ستافێ ڕیسێپشنێ دشێت ژمارا پەیوەندیا نەخۆشی بگۆڕیت. بەڕێڤەبەر تایبەتمەندیا دکتۆری دیار دکەت.",
    save: "زانیارییان بپارێزە",
    saving: "دهێتە پاراستن…",
    saved: "هاتە پاراستن",
    failed: "گۆڕین نەهاتە پاراستن. ژمارەیێ بپشکنە و دووبارە هەول بدە.",
  },
  ar: {
    eyebrow: "صفحة المريض",
