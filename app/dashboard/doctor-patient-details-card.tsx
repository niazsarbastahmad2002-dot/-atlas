...
const copy = {
  ...
  ku: {
    ...
    phone: "ژمارەی سکرتێر بۆ ئەم پزیشکە",
    phonePlaceholder: "0750 123 4567",
    receptionistNote: "سکرتێر دەتوانێت ژمارەی پەیوەندی نەخۆش بگۆڕێت. بەڕێوەبەر پسپۆڕی پزیشک دیاری دەکات.",
    save: "پاشەکەوتکردن",
  ...
  bd: {
    ...
    phone: "ژمارا سکرتێرێ بۆ ڤی دکتۆری",
    phonePlaceholder: "0750 123 4567",
    receptionistNote: "سکرتێر دشێت ژمارا پەیوەندیا نەخۆشی بگۆڕیت. بەڕێڤەبەر تایبەتمەندیا دکتۆری دیار دکەت.",
