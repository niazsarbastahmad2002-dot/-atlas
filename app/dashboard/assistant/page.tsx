  ...
  return (
    <main className="atlas-ai-page shell">
      <header className="atlas-ai-page-header">
        <Link className="button button-ghost button-small atlas-ai-back" href={scheduleHref} prefetch>
          {t.backToSchedule}
        </Link>
        {clinics.length > 1 ? (
