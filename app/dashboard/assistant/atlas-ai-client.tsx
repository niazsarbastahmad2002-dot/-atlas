...
const copy: Record<UiLocale, Copy> = {
  en: {
    ...
    beta: "Beta · read-only",
    privacy: "Atlas sends your question plus aggregated appointment statistics. Do not include patient names, phone numbers, message contents, or clinical information in your question.",
  ...
  ku: {
    ...
    privacy: "Atlas AI پرسیارەکەت لەگەڵ ئاماری کۆکراوەی مەوعیدەکان دەنێرێت. ناوی نەخۆش، ژمارەی مۆبایل، ناوەڕۆکی نامە یان زانیاری پزیشکی لە پرسیارەکەتدا مەنووسە.",
  ...
  bd: {
    ...
    privacy: "Atlas AI پسیارا تە ل گەل ئامارێن کۆمکری یێن مەوعیدان دفرێنیت. ناڤێ نەخۆشی، ژمارا موبایلێ، ناڤەروکا پەیامان یان زانیاریێن پزیشکی د پسیارا خۆ دا مەنووسە.",
  ...
  ar: {
    ...
    privacy: "Atlas AI يرسل سؤالك ويّاه إحصائيات مجمعة للمواعيد. لا تكتب اسم المريض أو رقم الهاتف أو محتوى الرسائل أو معلومات طبية في سؤالك.",
