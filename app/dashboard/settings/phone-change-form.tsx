...
const copyByLocale: Record<UiLocale, Copy> = {
  en: {
    ...
    help: "Use this only when you want to move your Atlas login to a different phone number. Your Atlas account, clinic membership, ownership, and permissions stay the same.",
    ...
    verifying: "Verifying…",
    samePhone: "That is already your Atlas sign-in phone. Nothing needs to change.",
    invalidPhone: "Enter a valid Iraqi mobile number, for example 0750 123 4567 or +964 750 123 4567.",
  ...
  ku: {
    ...
    help: "تەنها کاتێک ئەمە بەکاربهێنە کە دەتەوێت چوونەژوورەوەی Atlas بگوازیتە ژمارەیەکی تر. هەژمارەکەت، ئەندامێتی کلینیک، خاوەندارێتی و دەسەڵاتەکانت هەر وەک خۆیان دەمێننەوە.",
    ...
    samePhone: "ئەمە هەر ژمارەی ئێستای چوونەژوورەوەی Atlas ـەکەتە. پێویست بە گۆڕین نییە.",
    invalidPhone: "ژمارەیەکی دروستی مۆبایلی عێراقی بنووسە، وەک 0750 123 4567 یان +964 750 123 4567.",
  ...
  bd: {
    ...
    help: "تەنێ دەمێ ئەڤێ بکاربینە کو تو دخوازیت چوونەژوورا Atlas بگوهێزیتە ژمارەکا دی. هەژمار، ئەندامەتیا کلینیکێ، خاوەنداری و دەستهەلاتێن تە هەر وەک خۆ دەمینن.",
    ...
    samePhone: "ئەڤە هەر ژمارا چوونەژوورا Atlas یا تەیە. پێدڤی ب گوهارتنێ نینە.",
    invalidPhone: "ژمارەکا دروست یا موبایلا عێراقی بنڤیسە، وەک 0750 123 4567 یان +964 750 123 4567.",
  ...
  ar: {
    ...
    help: "استخدم هذا فقط إذا تريد نقل دخول Atlas إلى رقم هاتف مختلف. حسابك وعضويتك وملكية العيادة وصلاحياتك تبقى نفسها.",
    ...
    samePhone: "هذا هو نفس رقم دخول Atlas الحالي. لا تحتاج إلى تغييره.",
    invalidPhone: "أدخل رقم موبايل عراقي صحيح، مثل 0750 123 4567 أو +964 750 123 4567.",
