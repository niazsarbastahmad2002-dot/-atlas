...
const appearanceCopy: Record<UiLocale, {
  ...
  ku: {
    label: "ڕووکار",
    help: "ڕووکاری Atlas لەم ئامێرە هەڵبژێرە. ڕوون ڕەنگی تاریکی زۆرەملێکراوی وێبگەڕ دەوەستێنێت.",
    light: "ڕوون",
    dark: "تاریک",
    system: "بەپێی ئامێر",
  ...
  bd: {
    label: "ڕووکار",
    help: "ڕووکاری Atlas ل سەر ڤی ئامێری هەلبژێرە. ڕوون تاریکیا زۆرەملێکری یا وێبگەڕی راوەستینیت.",
    light: "ڕوون",
    dark: "تاریک",
