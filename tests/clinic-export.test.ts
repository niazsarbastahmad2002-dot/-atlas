...
test("clinic archive filenames cannot inject paths or response-header characters", () => {
  assert.equal(
    clinicArchiveFilename(' ../../Clinic "One"\r\nInjected: yes ', "2026-08-26T08:00:00.000Z"),
    "atlas-Clinic-One-Injected-yes-2026-08-26.json",
  );
});
